  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold">Fulfillment Point</h1>
          <p className=" text-gray-500">
            Change your Fulfillment Point Setting
          </p>
        </div>
        <Button className="w-50 h-12 bg-[#004370] hover:bg-[#004370] text-white">
          Add New Fulfillment Points{" "}
        </Button>
      </div>
