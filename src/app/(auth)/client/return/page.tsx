  ...
  return (
    <div className="p-6 bg-card">
      <ReturnModal
        ...
        setOpenModal={() => setShowReturnModal({ open: false, products: [], showQuantity: true })}
            ...
            <TableRow key={index}>
              ...
              <TableCell>
                {tab === "jobs" ? (
                  <Button
                    onClick={() =>
                      setShowReturnModal({ open: true, products: [item], showQuantity: true })
                    }
                  ...
                  <div className="flex flex-row gap-2">
                    ...
                    <Button
                      onClick={() =>
                        setShowReturnModal({ open: true, products: [item], showQuantity: false })
                      }
                      variant="outline"
